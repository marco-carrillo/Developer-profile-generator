...
inquirer.prompt(questions).then(answers=>{
    ...
    axios.get(queryUrl).then(({data})=> {  // Getting user profile via API call to Github
        ...
        axios.get(queryUrl).then(response=>{
            ...
            if(nbrPubRep>100){getNextPage(response.headers.link)}
            ...
            console.log('Successfully called GitHub API to get Github stars');
        ...
        });      // Axios second call to get GitHub stars
